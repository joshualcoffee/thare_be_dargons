defmodule ThareBeDargonsWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ThareBeDargons.MyChannel do
        use ThareBeDargonsWeb, :channel
        alias ThareBeDargonsWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :thare_be_dargons,
                        pubsub_server: ThareBeDargons.PubSub
end
